...
const Blogs = () => {
    return (
        <div className='bg-gray-200'>
            ...
            <div className='p-20'>
                <h2 className='text-xl font-bold'>4. You have an array of products. Each product has a name, price, description, etc. How will you implement a search to find products by name?
